...
<div class="content-wrapper">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header bg-primary">
                            <h5 class="modal-title text-white" id="addCategoryModalLabel">Cashiers</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <form id="saveCashiers">
                            <div class="modal-body">
                              
                              <div class="form-group">
                                <label for="">Cashiers <span class="text text-danger fw-bold">*</span></label>
            ...
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Home /</span> Cashiers</h4>
               ...
               <div class="my-3">
                ...
                <i class="menu-icon tf-icons bx bx-plus"></i> Cashiers
                </button>
               </div>
              <div class="card">
                <h5 class="card-header">All Cashiers</h5>
