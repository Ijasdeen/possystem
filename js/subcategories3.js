$(function() {
        ...
        $('#usubcategory11').on('change', function () {
    ...
    $('#uucategoryName').on('change', function () {
    ...
    showOffErrorData(); 
     ...
     $('#subcategoryUpdateForm').on('submit',function(e){
        e.preventDefault(); 
        let uucategoryName= $('#uucategoryName').val(); 
        let usubcategory11 = $('#usubcategory11').val(); 
        let usubcategory2 = $('#usubcategory2').val(); 
        let uusubcategory3name = $('#uusubcategory3name').val(); 
        let uusubcategory3code = $('#uusubcategory3code').val(); 

        let categoryNameText = $("#uucategoryName option:selected").text();
        let subcategory11Text = $('#usubcategory11 option:selected').text();
        let subcategory2Text = $('#usubcategory2 option:selected').text();
        ...
        $.ajax({
            ...
            method: 'POST',
            data: {
                uucategoryName: uucategoryName,
                usubcategory11: usubcategory11,
                usubcategory2: usubcategory2,
                uusubcategory3name: uusubcategory3name,
                uusubcategory3code: uusubcategory3code,
                subcategory11Text:subcategory11Text, 
                subcategory2Text:subcategory2Text, 
                categoryNameText:categoryNameText, 
                id : sessionStorage.getItem('subcategory3_id'),
                updateSubcategory3: 1
            },
            success: function (data) {
                if (data == 1) {
                    toastr.success("Subcategory 3 updated successfully.");
                    $('#subcategoryUpdateForm')[0].reset();
                    $('#editModalsection').modal('hide');
                    showOffErrorData();
                } else if (data == 12) {
            ...
            error: function (err) {
                toastr.error("Error updating subcategory 3: " + err);
            }
        });
    ...
    sessionStorage.setItem('subcategory3_id', id);
    ...
    $('#uusubcategory3code').val(subcategory3Name);
