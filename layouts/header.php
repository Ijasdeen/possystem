          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="subcategory1.php" class="menu-link">
                    <div data-i18n="Container"><i class="menu-icon tf-icons bx bx-layer"></i>&nbsp;Sub category 1</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="subcategory2.php" class="menu-link">
                    <div data-i18n="Fluid"><i class="menu-icon tf-icons bx bx-layer"></i>&nbsp;Sub Category 2</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="subcategory3.php" class="menu-link">
                    <div data-i18n="Blank"><i class="menu-icon tf-icons bx bx-category-alt"></i>&nbsp;Sub Category 3</div>
                  </a>
                </li>
 
                 <li class="menu-item">
                  <a href="brand.php" class="menu-link">
                    <div data-i18n="Blank"><i class="menu-icon tf-icons bx bx-purchase-tag-alt"></i>&nbsp;Brand</div>
                  </a>
                </li>

                  <li class="menu-item">
                  <a href="color.php" class="menu-link">
                    <div data-i18n="Blank"><i class="menu-icon tf-icons bx bx-palette"></i>
&nbsp;Color</div>
                  </a>
                </li>
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="suppliers.php" class="menu-link">
                    <div data-i18n="Container"><i class="menu-icon tf-icons bx bx-layer"></i>&nbsp;Supplier</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="employee.php" class="menu-link">
                    <div data-i18n="Fluid"><i class="menu-icon tf-icons bx bx-id-card"></i>&nbsp;Employee</div>
                  </a>
                </li>
            ...
            <li class="menu-item">
              <a href="expensecategories.php" class="menu-link">
                <i class="menu-icon tf-icons bx bx-wallet"></i>
                  <div data-i18n="Analytics">Expense Categories</div>
              </a>
            </li>
        ...
        <li class="menu-item">
            ...
            <li class="menu-item d-none">
              <a
                ...
                class="menu-link"
              >
                <i class="menu-icon tf-icons bx bx-support d-none"></i>
